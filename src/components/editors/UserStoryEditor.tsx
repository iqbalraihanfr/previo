...
export function UserStoryEditor({ fields, onChange, projectId }: EditorProps) {
  ...
  const getFrDisplayId = (idx: number) =>
      ...
      <div className="space-y-4 shrink-0 pb-4">
        {items.map((item: any, itemIdx: number) => {
          ...
          return (
            <div
              key={item.id}
              className="flex flex-col gap-4 p-4 border rounded-md bg-background relative shadow-sm"
            >
              ...
              <div className="grid gap-2">
                <Label className="text-xs text-muted-foreground font-semibold uppercase">
                  As a... <span className="text-destructive">*</span>
                </Label>
              ...
              <div className="grid gap-2">
                <Label className="text-xs text-muted-foreground font-semibold uppercase">
                  I want... <span className="text-destructive">*</span>
                </Label>
                <Input
                  value={item.goal || ""}
                  onChange={(e) =>
                    updateItem(item.id, { goal: e.target.value.slice(0, 200) })
                  }
              ...
              <div className="grid gap-2">
                <Label className="text-xs text-muted-foreground font-semibold uppercase">
                  So that... <span className="text-destructive">*</span>
                </Label>
                <Input
                  value={item.benefit || ""}
                  onChange={(e) =>
                    updateItem(item.id, {
                      benefit: e.target.value.slice(0, 200),
                    })
                  }
                        ...
                        >
                          <div className="flex items-center justify-between">
                            ...
                            <Button
                              ...
                              onClick={() => removeCriteria(item.id, idx)}
                            >
                          ...
                          <div className="grid gap-1.5">
                            <div className="flex items-center gap-2">
                              <span className="text-[10px] font-semibold text-green-600 w-12 shrink-0">
                                GIVEN
                              </span>
                              <Input
                            ...
                            <div className="flex items-center gap-2">
                              <span className="text-[10px] font-semibold text-blue-600 w-12 shrink-0">
                                WHEN
                              </span>
                              <Input
                            ...
                            <div className="flex items-center gap-2">
                              <span className="text-[10px] font-semibold text-purple-600 w-12 shrink-0">
                                THEN
                              </span>
                              <Input
