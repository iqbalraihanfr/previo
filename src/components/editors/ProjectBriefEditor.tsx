...
export type EditorProps = StructuredEditorProps<ProjectBriefFields>;
  ...
  return (
    <div className="flex-1 overflow-y-auto workspace-scroll">
      <div className="max-w-5xl mx-auto p-5 lg:p-6 space-y-10 pb-16">
        ...
        {/* Header Section */}
        <div
          className="space-y-8 animate-in fade-in slide-in-from-top-4 duration-1000"
          id="project-brief-context"
        >
        ...
        <div className="grid grid-cols-1 gap-20">
          ...
          {/* Strategic Context */}
          <div id="project-brief-strategic-context">
          ...
          {/* Boundaries */}
          <div id="project-brief-boundaries">
